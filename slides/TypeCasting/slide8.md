...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
    <div class="container1">
      <div v-click class="mini-container-1" style="margin-bottom:10px;margin-top:-10px;">char → int (ASCII)</div>
      <JavaRunner v-click/>
    </div>
    <div class="container2" style="margin-top:38px">
      <div v-click class="mini-container">Given <code>char ch = 'Z'</code>, print its <b>ASCII value</b>.</div><br>
      <div v-click class="mini-container">Print ASCII values of <b>'A'</b>, <b>'a'</b>, <b>'0'</b> and verify the ranges you know.</div>
    </div>
  </div>
</div>
