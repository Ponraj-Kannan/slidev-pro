...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
    <div class="container1">
      <div v-click class="mini-container-1" style="margin-bottom:10px;margin-top:-10px;">Practice Problem 1 - Case Conversion via ASCII</div>
      <JavaRunner v-click/>
    </div>
    <div class="container2" style="margin-top:38px">
      <div v-click class="mini-container">Given <code>char ch = 'G'</code>, convert it to <b>lowercase</b> using ASCII arithmetic and print the result.</div><br>
      <div v-click class="mini-container">Given <code>char ch = 'm'</code>, convert it to <b>uppercase</b> and print the result.</div><br>
      <div v-click class="mini-container" style="background-color:#6fcf9745;border:1px solid #1f6f5fa7;text-align:center;">Why do we add/subtract <b>32</b> for case conversion?</div>
    </div>
  </div>
</div>
