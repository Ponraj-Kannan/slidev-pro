...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
    <div class="container1">
      <div v-click class="mini-container-1" style="margin-bottom:10px;margin-top:-10px;">Narrowing Conversion</div>
      <JavaRunner v-click/>
    </div>
    <div class="container2" style="margin-top:38px">
      <div v-click class="mini-container">Declare <code>double d = 9.78</code>. Narrow it to <b>float</b>, <b>int</b>, and <b>byte</b>. Print all three and observe the data loss at each step.</div>
    </div>
  </div>
</div>
