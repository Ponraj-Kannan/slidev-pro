...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
    <div class="container1">
      <div v-click class="mini-container-1" style="margin-bottom:10px;margin-top:-10px;">Widening Conversion</div>
      <JavaRunner v-click/>
    </div>
    <div class="container2" style="margin-top:38px">
      <div v-click class="mini-container">Declare a <b>byte</b> variable with value <b>100</b>. Widen it step by step to <b>short</b>, <b>int</b>, <b>long</b>, <b>float</b>, and <b>double</b>. Print each value.</div>
    </div>
  </div>
</div>
