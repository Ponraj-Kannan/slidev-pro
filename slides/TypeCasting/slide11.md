...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
    <div class="container1">
      <div v-click class="mini-container-1" style="margin-bottom:10px;margin-top:-10px;">Practice Problem 2 - Casting in Expressions</div>
      <JavaRunner v-click/>
    </div>
    <div class="container2" style="margin-top:38px">
      <div v-click class="mini-container">Given <code>int a = 7</code> and <code>int b = 2</code>, print the <b>exact decimal result</b> of a ÷ b using casting.</div><br>
      <div v-click class="mini-container" style="background-color:#6fcf9745;border:1px solid #1f6f5fa7;text-align:center;">What is the difference between <code>(double)(a/b)</code> and <code>(double)a/b</code>?</div>
    </div>
  </div>
</div>
