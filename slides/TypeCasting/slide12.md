...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
    <div class="container1">
      <div v-click class="mini-container-1" style="margin-bottom:10px;margin-top:-10px;">Practice Problem 3 - String ↔ Primitive</div>
      <JavaRunner v-click/>
    </div>
    <div class="container2" style="margin-top:38px">
      <div v-click class="mini-container">Given <code>String s = "2025"</code>, convert it to <b>int</b>, add <b>5</b>, and print the result.</div><br>
      <div v-click class="mini-container">Given <code>double price = 49.99</code>, convert it to a <b>String</b>, append <code>" INR"</code>, and print it.</div>
    </div>
  </div>
</div>
